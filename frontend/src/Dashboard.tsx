    ...
    <div className="animate-enter" style={{ padding: '1.25rem', paddingBottom: '7rem' }}>
      ...
      {tab === 'inicio' && (
        <>
          ...
          <h3 style={{ fontSize: '0.9rem', fontWeight: 900, color: 'var(--color-secondary)', textTransform: 'uppercase', marginBottom: '1rem', letterSpacing: '0.05em' }}>Cronograma de la Semana</h3>
